...
function changeTab(whichTab) {
	...
	function printOutTab(theTabName, theTabType, theTabCount, theTabNumber, adjustWidth) {
			...
			var theString;
			theString = '<div style = "float:left;">';
			theString += '<div class="select0" id="whichTab'+ theTabNumber +'">';
			  //theString += '<ul>';
				theString += '<a class="tab" href="javascript:searchPageInstance.setSelectedTab(\''+ theTabType +'\');">';
				  theString += '<em>'
				  if (adjustWidth)
				  ...
				  //theString += '><span>';
				   // theString += '<a href="javascript:searchPageInstance.setSelectedTab(\''+ theTabType +'\');" class="active">';
				      ...
				      theString += theTabName;
							theString += '</span>';
							theString += '<span class="tab-count">';
							theString += ' ('+ theTabCount +')';
				   		theString += '</span>';
				  theString += '</em>';
				theString += '</a>';
			  //theString += '</ul>';
...
function printOutTabTemplate(theTabName, theTabType, theTabNumber, theTabClass, theTabLink, theTabTooltip, adjustWidth)
{
	...
	if (theTabTooltip)
		theString += '<a class="tab staticTip" onMouseOver="setTipText(&quot;'+theTabTooltip+'&quot;);" href="'+ theTabLink +'" class="active">';		
	else
		theString += '<a class="tab" href="'+ theTabLink +'" class="active">';
