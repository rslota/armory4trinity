...
CustomSelect.prototype = {
	toggle: function() {
		...
		this.cancelClose();
		//if(hasClassName(this.options, this.classNames.optionsActive)){
		//	this._deactivate()
		//}
	...
	_activate: function() {
		...
		//addClassName(this.handle, this.classNames.handleActive);
		//addClassName(this.options, this.classNames.optionsActive);
	},
	_deactivate: function() {
		if(CustomSelect.openInstance == this)
			CustomSelect.openInstance = null;
		//removeClassName(this.handle, this.classNames.handleActive);
		//removeClassName(this.options, this.classNames.optionsActive);
