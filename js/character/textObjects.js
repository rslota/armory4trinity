...
function meleeSpeedTextObject() {
	...
	var titleAppend = "";
	var haste = spanYellow + spanYellowEnd;
...
function meleeHitRatingTextObject() {
	...
	var increasedHitPercent = isApplicable(meleeHitRatingIncreasedHitPercent)?spanYellow + meleeHitRatingIncreasedHitPercent + spanYellowEnd:'';
